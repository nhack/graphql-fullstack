...
var todo_service_rest_1 = require('../../../../client/dev/todo/services/todo-service-rest');
var MockTodoService = (function (_super) {
    ...
    MockTodoService.prototype.add = function (message) {
        return Promise.resolve({ todoMessage: message });
    };
    MockTodoService.prototype.remove = function (id) {
        return Promise.resolve();
    };
    return MockTodoService;
}(todo_service_rest_1.TodoServiceRest));
